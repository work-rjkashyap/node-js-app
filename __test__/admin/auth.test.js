...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Sydney_Moore92',
      password: 'KKA0z6yRG4GMbDg',
      email: 'Javier.Rempel@hotmail.com',
      name: 'Kerry Harber',
      shippingAddress: [
        {
          _id: false,
      ...
      userType: 939,
      mobileNo: '(067) 986-6204',
      resetPasswordLink: {},
      loginRetryLimit: 3,
      loginReactiveTime: '2022-09-23T14:48:03.382Z',
      id: '6310de26243c29c29d03177d'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Colten71',
        'password':'D9n4k_7tGTpoe9X',
        'email':'Olin_Reichert85@yahoo.com',
        'name':'Ismael Kessler',
        'shippingAddress':[{
          '_id':false,
          'pincode':'Agent',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Olin_Reichert85@yahoo.com', });
