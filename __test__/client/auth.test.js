...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Kameron87',
      password: 'd7gfXKOEUJ4m3hR',
      email: 'Richie41@gmail.com',
      name: 'Matt Kirlin',
      shippingAddress: [
        {
          _id: false,
          pincode: 'driver',
          address1: 'Convertible',
          address2: 'SDD',
          landmark: 'Dollar',
          city: 'deposit',
          isDefault: false,
      ...
      userType: 794,
      mobileNo: '(806) 605-5172',
      resetPasswordLink: {},
      loginRetryLimit: 695,
      loginReactiveTime: '2022-10-03T02:08:16.802Z',
      id: '6310de26243c29c29d031855'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Antoinette_Hermiston31',
        'password':'j1IPhagEBLTXK1B',
        'email':'Ellis.Raynor@hotmail.com',
        'name':'Jenny Hintz',
        'shippingAddress':[{
          '_id':false,
          'pincode':'Rica',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/client/auth/forgot-password')
      .send({ 'email':'Ellis.Raynor@hotmail.com', });
