...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Kayli25',
      password: 'TnEHppwAhw2Ad7j',
      email: 'Drew_Jenkins93@hotmail.com',
      name: 'Ginger Botsford',
      shippingAddress: [
        {
          _id: false,
          pincode: 'target',
      ...
      wishlist: [ {
        _id: false,
        productId: 'strategize' 
      } ],
      userType: 302,
      mobileNo: '(554) 192-1582',
      resetPasswordLink: {},
      loginRetryLimit: 592,
      loginReactiveTime: '2022-12-21T00:18:12.131Z',
      id: '6310de26243c29c29d0317e9'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Anabelle.Feil',
        'password':'5O2PFPfsPtJuL9H',
        'email':'Nick.Stracke63@gmail.com',
        'name':'Jimmie Moen',
        'shippingAddress':[{
          '_id':false,
          'pincode':'Home',
        ...
        'wishlist':[{
          '_id':false,
          'productId':'bleeding-edge'
        }],
        'userType':authConstant.USER_TYPES.User,
        'mobileNo':'(924) 375-3579',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Nick.Stracke63@gmail.com', });
